...
class ImgFeats(nn.Module):
	def __init__(self, args):
		...
		self.linear_bert = nn.Linear(768, 128) #!!!! open when use lstm
		### img model
		if self.use_img:
